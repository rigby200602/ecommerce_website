...
const MainBanner = () => {
  return (
    <div className='relative'>
      ...
      md:justify-center pb-[60%] md:pb-0 px-4 md:pl-18 lg:pl-24'>
        ...
        hover:bg-primary-dull transition rounded text-white cursor-pointer'>
            ...
            <img className='md:hidden transition group-focus:translate-x-1'
              src={assets.white_arrow_icon} alt="white_arrow"></img>
          </Link>

          <Link to={"/products"} className='group hidden md:flex items-center gap-2
        px-9 py-3 cursor-pointer'>
            Explore deals
            <img className='transition group-focus:translate-x-1'
              src={assets.black_arrow_icon} alt="black_arrow"></img>
          </Link>
        </div>
      </div>
    </div>
